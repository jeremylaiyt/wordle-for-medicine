# Wordle to guess medicine

Purely for fun only. A wordle-inspired game that allow you to guess medicine name instead of just random english words.

- Project forked from "Wordle Clone"
